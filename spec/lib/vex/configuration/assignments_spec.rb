...
describe Vex::Dsl::Configuration::Assignments do
  ...
  describe "#vex_associations" do
    it "should be a wrapper of the appropriate type" do
      AssignmentTestSingularA.new.vex_associations.is_a?(Vex::Dsl::Wrappers::Association::Wrapper).should be_true
      AssignmentTestSingularB.new.vex_associations.is_a?(Vex::Dsl::Wrappers::Association::Wrapper).should be_true
      AssignmentTestSingularC.new.vex_associations.is_a?(Vex::Dsl::Wrappers::Association::Wrapper).should be_true
      AssignmentTestSingularD.new.vex_associations.is_a?(Vex::Dsl::Wrappers::Association::Wrapper).should be_true
    end
  end
end